...
| 3 | Recommendation Intent (Low) | Motivation | `actions.motivation` | `actions.js` | **action:** Membantu peserta membangun strategi dan kepercayaan diri untuk memotivasi tim secara lebih konsisten. **rationale:** Motivation adalah dimensi dengan skor terendah ({score}). |
